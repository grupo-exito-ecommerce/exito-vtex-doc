...
<a href="#trabajandocon-Vtex-eact](#trabajandocon vtex <br>
<a href="#l-y-react)

*  [Lista-decomponentes-actuales">Lista-d -componentes</a><br>
...
<li><a href="
(https://code.visualstudio.com/">Visual Studio Code</a>) Editor<br>
3
...
<li><a href="
https://www.npmjs.com/package/exito-cli">Exito Cli</a> Linea de comandos para éxito</li>
<li><a href="
http://cmder.net/">CMDER</a>) Terminal Para windows</li>
<li><a href="
https://www.iterm2.com/">Iterm2</ Terminal para Mac</li>
<li><a href="
https://docs.aws.amazon.com/cli/latest/userguide/install-windows.html">Aws Cli</a>) Linea de comandos para Amazon</li>
</ol>
<h2 id="guía">Guía</h2>
...
<p>
  ...
  React Básico <a href="https://www.youtube.com/watch?v=bG53Pw17tog&amp;list=PLeWI3XlFEVOX6jACDygzApsvigQiDrun8">Youtube CodeJobs</a><br>)
...
<p><a href="https://github.com/grupo-exito-ecommerce/exito-vtex-doc/blob/master/resources/examples/components/documentatio/CHANGELOG-BASIC.md">)
...
Se plantea la siguiente estructura, donde <strong>exito</strong> es el workspace principal o productivo, el workspace <strong>develop</strong> es el workspace pre productivo y los workspaces <strong>**qa1, qa2, qa3</strong>** son los workspace destinados para los equipos de SQA para realizar las validacionesbashhello-react-typescript
 de los desarrollos que se planteen para el sprint. Cada desarrollador deberá de crear su workspace definiendo el equipo de SQA que realizara sus validaciones técnicas y el tipo de desarrollo que esta realizando en ese momento.</p>
...
<tr>
<td></td>
<td><strong><a href="/)** | **[qa2](https://qa2--exito.myvtex.com/)** | **[qa3](https://developqa3--exito.myvtex.com/">develop</a></strong></td>
<td></td>
</tr>
<tr>
...
Creación de- un- nuevo- componentevtex-cli">C](#creación -de -un -nuevo -componente</a></li>
</ul>
<ul>
...
<h3 id="reacióndeunnuevocomponente-con-vtex-cli">exito-cli)
...
<h3 id="instalación-de-dependenciasparaeldminMaik3345/hello-react-ts)
...
Pueden encontrar la especificación técnica de los archivo en el documento en <a href="[Github](https://github.com/grupo-exito-ecommerce/exito-vtex-doc/blob/master/directory/continuos-integration-config/continuos-integration-config.md">Github</a></p>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODM1NDQ1MzE2XX0=
-->