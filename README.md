...
<tr>
<td></td>
<td>[exito](<a href="un- nuevo- componente-con-vtex-cli">C](#creación -de -un -nuevo -componente</a></li>
</ul>
<ul>
...
<pre class=" language-bash"><code class="prism  language-bashhello-react-typescript
</code></pre>
<h3 id="r```
...
vtex install vtex.pages#configuraci-editor</p>
<p>
...
Se van a presentar varios errores en cuanto a la referencia de la dependencia `render` la cual ha cambiado por `vtex.render-runtime`.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA5OTAzMTQ0MF19
-->