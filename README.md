...
<p><a href="#recursos- necneesarios">sRecursos necesarios</a><br>
<a href="#gu%C3%ADa">Guía</a><br>
<a href="#vtex-cli">Vtex Cli</a><br>
<a href="#trabajando-con-vVtex-y-react">Ttrabajando con Vvtex + Reacteac>
<a href="#l-y-react)
...
<li><a href="
(https://code.visualstudio.com/">Visual Studio Codia e</a>) Editor<br>
3

2.1 Extensiones Básicas:
<ul>
<li><a href="
https://marketplace.visualstudio.com/items?itemName=dsznajder.es7-react-js-snippets">ES7 React/Redux/GraphQL/React-Native snippets</a></li>
...
<li><a href="
https://www.npmjs.com/package/exito-cli">Exito Cli</a> Línea Líin de comandos para éxito</li>
<li><a href="
http://cmder.net/">CMDER</a>) Terminal Para windows</li>
<li><a href="
https://www.iterm2.com/">Iterm2</a> Terminal para Mac</li>
<li><a href="
https://docs.aws.amazon.com/cli/latest/userguide/install-windows.html">Aws Cli</a> Línea de comandos para Amazon</li>
</ol>
<h2 id="guía">Guía</h2>
...
<p>
  ...
  React Básico <a href="https://www.youtube.com/watch?v=bG53Pw17tog&amp;list=PLeWI3XlFEVOX6jACDygzApsvigQiDrun8">Youtube CodeJobs e</a><br>)

React Curso Completo <a href="ehttps://exito.udemy.com/react-the-complete-guide-incl-redux/learn/v4/overview">Udemy</a><br>
...
para manejar la versión de nuestros componentes emplearemos la siguiente guía <a href="https://docs.npmjs.com/about-semantic-versioningar">semantic-versioning</a></p>
<h3 id="como-se-debe#configuracin-de-documentar-el-código-en-react">Como se deben de documentar el código en React</h3>
<p>

  
Para realizar la documentación en React se emplea el estándar definido por <a href="https://react-styleguidist.js.org/docs/documenting.html">react-styleguidist</a> donde se definen diversas técnicas necesarias para documentar los componentes creados, además de esto permite generar una documentación automática que permite visualizar muy bien el contenido que hemos documentado. <a href="https://github.com/styleguidist/react-styleguidist/tree/master/examples/basic">demo</a></p>
<p>)

 Se recomienda manejar el concepto de <a href="http://usejsdoc.org/">jsDoc</a> para los comentarios de nuestros componentes.</p>
<p>
...
<p><a href="https://github.com/igrupo-exito-ecommerce/exito-vtex-doc/blob/master/resources/examples/components/documentation/CHANGELOG-BASIC.md">Basic Changelog)
a he</a></p>
<p><a href="https://github.com/grupo-exito-ecommerce/exito-vtex-doc/blob/masd/codeproet idnta lai/hprceter/resources/examples/components/documentation/README-BASIC.md">Basic Readme<e/a></p>
...
qa1_header–exito.myvtex.com</strong><br>
...
<tr>
<td></td>
<td><strong><a href="tto https///tt://dev--exito.myvtex.com/">developqaeteevelop</a></strong></td>
<td></td>
</tr>
<tr>
...
<ul>
<li><a href="nstalaci%C3%B3n-ación de- dependencias- para- el-a Admin- de-v Vtex">I](#instalación de dependencias -para -el A-admin de Vtex</a></li>
</ul>
<ul>
<li><a href="#creaci%C3%B3n-de-un-nuevo-componente-con-exito-cli">Creación de un nuevo componente con Exito cl-de-vtex)

i</a></li>
</ul>
<h3 id="instalreación-de-dependencias-para-el-admin-de-vtex">Itetli
 nstalación den dependencias para el Admin de Vtex</h3>
<p>Las siguientes dependencias permiten agregar comportamiedep
...
<p><em>Nota</em>:  Podemos realizar la publicación directa en el workspace master.</ph2 id="lista-de-componentes-actuales-en-react">Lista de componentes actuales en React</h2>
...
<h4 id="como-puedo-verificar-el-build-realizado-cuando-realice-un-push-a-los-branchs-developy-master">Como puedo verificar el build realizado cuando realice un push a los branchs <code>develop) y [SonarQube](https://www.sonarqube.org/)

2.  `exito generate template [name-repository]</code>:</li>
</ol>
<p>`:

Comando que genera los archivo <code>`develop-template.json</code> y <code>` y `master</code></h4>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjcxODM3OTY0XX0=
-->